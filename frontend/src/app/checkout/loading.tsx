      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="md:flex md:gap-24 lg:gap-32">
          <div className="flex-1 px-16 md:px-24 md:pr-0 pb-24 md:pb-32 space-y-16">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white border border-gray-200 rounded-xl p-20 shadow-sm animate-pulse">
                <div className="h-16 bg-gray-200 rounded w-1/3 mb-16"></div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <div className="h-12 bg-gray-200 rounded w-full"></div>
                  <div className="h-12 bg-gray-200 rounded w-full"></div>
                  <div className="h-12 bg-gray-200 rounded w-full md:col-span-2"></div>
                  <div className="h-12 bg-gray-200 rounded w-full"></div>
                  <div className="h-12 bg-gray-200 rounded w-full"></div>
                </div>
              </div>
          ...
          <div className="md:w-[360px] lg:w-[380px] flex-shrink-0 px-16 md:px-0 md:pr-24 pb-32">
            <div className="bg-white border border-gray-200 rounded-xl p-20 shadow-sm animate-pulse md:sticky md:top-[96px]">
